...
describe('generateStreetName', () => {
  ...
  describe('testing invalid data in generateStreetName', () => {
    ...
    const data = [
      ...
      { length: 'a' as unknown as number, error: 'No street name found with that length' },
      { length: '&' as unknown as number, error: 'No street name found with that length' },
      { length: true as unknown as number, error: 'No street name found with that length' },
      { length: false as unknown as number, error: 'No street name found with that length' },
      { length: null as unknown as number, error: 'No street name found with that length' },
      { length: undefined as unknown as number, error: 'No street name found with that length' },
      { length: [] as unknown as number, error: 'No street name found with that length' },
      { length: {} as unknown as number, error: 'No street name found with that length' },
    ];
